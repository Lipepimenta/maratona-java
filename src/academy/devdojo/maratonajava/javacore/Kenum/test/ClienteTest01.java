...
public class ClienteTest01 {
    public static void main(String[] args) {
        Cliente cliente1 = new Cliente("Didi", TipoCliente.PESSOA_FISICA, TipoPagamento.DEBITO);
        Cliente cliente2 = new Cliente("Anthony", TipoCliente.PESSOA_JURIDICA, TipoPagamento.CREDITO);
